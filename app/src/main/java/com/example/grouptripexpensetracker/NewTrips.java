...
public class NewTrips extends AppCompatActivity implements View.OnClickListener
{
    ...
    public void addTrip(View v) {
        SQLiteDatabase db = openOrCreateDatabase("Trips", Context.MODE_PRIVATE, null);
