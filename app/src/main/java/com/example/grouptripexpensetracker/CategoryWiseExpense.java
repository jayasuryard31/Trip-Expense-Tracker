...
import com.example.grouptripexpensetracker.R;

public class CategoryWiseExpense extends AppCompatActivity
{
    String id;
    SQLiteDatabase db1;
    SQLiteDatabase db2;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        db1=openOrCreateDatabase("Trips", Context.MODE_PRIVATE, null);
        db2=openOrCreateDatabase("TripDatabase", Context.MODE_PRIVATE, null);
